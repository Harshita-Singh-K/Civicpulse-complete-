...
export function CitizenLogin({ onLogin, onRegisterClick, onBack }: CitizenLoginProps) {
  ...
  const handleGoogleLogin = () => {
    ...
    const popup = window.confirm('Sign in with Google?\n\nThis will open Google authentication.');
    if (popup) {
    ...
    <div className="h-screen flex flex-col bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="px-6 pt-8 pb-6">
        ...
        <div className="text-center">
          ...
          <h1 className="text-2xl mb-2">Citizen Login</h1>
          <p className="text-sm text-slate-600">Sign in to report and track civic issues</p>
        </div>
      </div>
      ...
      <div className="flex-1 px-6 pb-8 overflow-y-auto">
        <div className="max-w-md mx-auto">
          {/* Login Method Toggle */}
          <div className="bg-white rounded-xl p-1 shadow-md mb-6 flex">
            <button
